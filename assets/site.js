...
/* Hero shimmer — Cosmic's plate, lit.
   ...
   off screen or the ground is not Cosmic, and never started at all under
...
(function () {
  ...
  function live() {
    return onScreen && page.getAttribute('data-ground') === 'cosmic';
  }
